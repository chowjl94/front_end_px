...
<div className="grid md:grid-cols-2 gap-x-4 gap-y-8 xl:grid-cols-3 xl:gap-x-6">
    ...
    <div className="relative flex flex-col">
      ...
      {<div className='width:100%;height:0px;position:relative;padding-bottom:56.250%;'>
        ...
        <iframe title="myFrame" src='https://www.scorebat.com/embed/v/6158ccd574215/?utm_source=api&utm_medium=video&utm_campaign=v3' 
      ...
      <div className="flex-1 flex md:flex-col justify-between items-start md:items-stretch gap-3 px-2">
        <div className="mt-1 flex-1">
          <div className="flex justify-between items-center gap-3">
            <div>
              <span className="text-2xl font-bold">"Highlights"</span>
            </div>
